...
public class S3Factory {
    ...
    //ECS
    public static final String S3_ENDPOINT = "http://:9020"; // endpoint ECS

    
    //Object Scale
    //public static final String S3_ENDPOINT = "http://:80"; // endpoint ECS
    public static final String S3_ACCESS_KEY_ID = "dom";
    //public static final String S3_SECRET_KEY = ""; //dom
    public static final String S3_SECRET_KEY = ""; // 3.6.2 IAM
